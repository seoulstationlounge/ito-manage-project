...
import com.itosideproject.modules.study.event.StudyCreatedEvent;
import com.itosideproject.modules.study.event.StudyUpdateEvent;
...
import static com.itosideproject.modules.study.form.StudyForm.VALID_PATH_PATTERN;
...
public class StudyService {
    ...
    public void updateStudyDescription(Study study, StudyDescriptionForm studyDescriptionForm) {
        ...
        eventPublisher.publishEvent(new StudyUpdateEvent(study, "AIA_JOB 소개를 수정했습니다."));
    }
    ...
    private void checkIfExistingStudy(String path, Study study) {
        if (study == null) {
            throw new IllegalArgumentException(path + "에 해당하는 AIA_JOB가 없습니다.");
        }
    }
    ...
    public void close(Study study) {
        study.close();
        eventPublisher.publishEvent(new StudyUpdateEvent(study, "AIA_JOB를 종료했습니다."));
    }
    ...
    public void remove(Study study) {
        if (study.isRemovable()) {
            ...
            throw new IllegalArgumentException("AIA_JOB를 삭제할 수 없습니다.");
        }
    }
