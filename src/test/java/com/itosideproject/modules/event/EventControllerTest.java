...
import com.itosideproject.infra.AbstractContainerBaseTest;
import com.itosideproject.infra.MockMvcTest;
import com.itosideproject.modules.account.AccountFactory;
import com.itosideproject.modules.account.AccountRepository;
import com.itosideproject.modules.account.WithAccount;
import com.itosideproject.modules.account.Account;
import com.itosideproject.modules.study.Study;
import com.itosideproject.modules.study.StudyFactory;
...
class EventControllerTest extends AbstractContainerBaseTest {
    ...
    @Test
    @DisplayName("선착순 처리에 참가 신청 - 자동 수락")
    @WithAccount("keesun")
    ...
    @Test
    @DisplayName("선착순 처리에 참가 신청 - 대기중 (이미 인원이 꽉차서)")
    @WithAccount("keesun")
    ...
    @Test
    @DisplayName("참가신청 확정자가 선착순 처리에 참가 신청을 취소하는 경우, 바로 다음 대기자를 자동으로 신청 확인한다.")
    @WithAccount("keesun")
    ...
    @Test
    @DisplayName("참가신청 비확정자가 선착순 처리에 참가 신청을 취소하는 경우, 기존 확정자를 그대로 유지하고 새로운 확정자는 없다.")
    @WithAccount("keesun")
    ...
    @Test
    @DisplayName("관리자 확인 처리에 참가 신청 - 대기중")
    @WithAccount("keesun")
