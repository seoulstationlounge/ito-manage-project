...
public class PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAPackage("com.itosideproject.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("com.itosideproject.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("com.itosideproject.modules.(*)..")
